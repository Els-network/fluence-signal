...
const await_handler_ts_1 = __importDefault(require("await-handler-ts"));
...
class SignalService {
    ...
    register_identity(identity, callParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const [err, res] = yield await_handler_ts_1.default(this.user.register_user(util_1.StringToProtocolAddress(identity.id), Buffer.from(identity.identityKey)));
    ...
    create(username, callParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.user = identity;
            this.id = util_1.ProtocolAddressToString(this.user.address); // turn signal address to string
            return {
                id: util_1.ProtocolAddressToString(this.user.address),
                username: this.username,
                identityKey: Array.from(this.user.bundle.identityKey().serialize()),
    ...
    sign(data, callParams) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!onlyOwner(this.peer, callParams))
                throw new Error("Not Owner");
            const [err, result] = yield await_handler_ts_1.default(this.user.sign(Buffer.from(data)));
            return {
    ...
    decrypt(data, from, callParams) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!onlyOwner(this.peer, callParams))
                throw new Error("Not Owner");
            const [err, result] = yield await_handler_ts_1.default(this.user.decrypt(Buffer.from(data), util_1.StringToProtocolAddress(from)));
            return {
    ...
    encrypt(data, to, identity, callParams) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!onlyOwner(this.peer, callParams))
                throw new Error("Not Owner");
            const [err, result] = yield await_handler_ts_1.default(this.user.encrypt(Buffer.from(data), util_1.StringToProtocolAddress(to), identity ?
